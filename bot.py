...
def apply_initial_sound_law(char):
    """ 
    두음 법칙 적용 함수 
    요청하신 대로 '러' 계열(러, 럭, 런, 럴, 럼, 럽, 럿, 렁 등 초성이 'ㄹ'이고 모음이 'ㅓ'인 모든 글자)은 
    종성(받침) 여부와 상관없이 절대 변하지 않고 그대로 유지됩니다.
    """
...
bot.run('MTUyNjEwNTU4NDg2NzIxMzQ2NA.GseaI1.XeCWqIcA6KuaknxBEV1il0KHR5H5helxuqp_Jc')